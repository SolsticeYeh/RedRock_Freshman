    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            if (Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.UI.ViewManagement.StatusBar")) //手机状态栏
            {
                ...
                statusBar.BackgroundColor = APPTheme.APP_Color_Brush.Color;//标题栏背景色
                statusBar.ForegroundColor = Colors.White;//标题栏前景色
            }
            else //PC状态栏
            {
                var titleBar = ApplicationView.GetForCurrentView().TitleBar;
                titleBar.BackgroundColor = APPTheme.APP_Color_Brush.Color;//标题栏背景色
                titleBar.ForegroundColor = Colors.White;//标题栏前景色
                titleBar.ButtonHoverBackgroundColor = APPTheme.APP_Color_Brush.Color;//鼠标悬浮在三键上的背景色
                titleBar.ButtonHoverForegroundColor = Colors.White;//鼠标悬浮在三键上的前景色
                titleBar.ButtonBackgroundColor = APPTheme.APP_Color_Brush.Color;//按钮背景色
                titleBar.ButtonForegroundColor = Color.FromArgb(100, 255, 255, 254);//按钮前景色
                //titleBar.ButtonInactiveBackgroundColor = APPTheme.APP_Color;//按钮处于非活跃状态时的背景色
                //titleBar.ButtonInactiveForegroundColor = Colors.White;//按钮处于非活跃状态时的前景色
